...
\begin{definition}
	Let $f : X \to \reals$ be a function on a convex set $X$. We say that $f$ is \key{strictly convex} if, for all $x, y \in X$ and for all $\alpha \in [0, 1]$, we have
	\[
	...
	The function $f$ is \key{strictly concave} if $-f$ is strictly convex.
\end{definition}
