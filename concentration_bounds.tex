...
Throughout this chapter, we will assume that the pressure $P$ of $\phi$ is zero. \hl{[Remember to explain why in the Gibbs chapter!]} With this in mind, recall that
